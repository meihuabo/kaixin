...
<head>
  ...
  <script type="application/javascript" src="http://112.126.66.227:10005/js/jquery-1.11.2.min.js"></script>
  <style type="text/css">
        .left10{
            margin-left:10em;
        }
  ...
  <link rel="shortcut icon" href="data:image/png;base64," type="image/x-icon" />
    ...
    <body>
        <div class="box">
            <input id="refreshToken" type=text/>
            <input id="accessTokenBtn" type="button" value="获取token"/>
            <span class="left10" id="accessToken">{{.AccessToken}}</span>   
        </div>
        <div class="box">            
            <div><label>客服号：</label><input type="text" id="kf_account"/></div>
            <div><label>客服昵称：</label><input type="text" id="nickname"/></div>
            <div><label>密码：</label><input type="text" id="password"/><input id="addKeFu" type="button" value="添加客服"/></div> 
            <div id="kefuRet"></div>
        </div>
        <div class="box">
            
            <input id="wxServersBtn" type="button" value="获取微信服务器ip列表"/>
            <span class="left10" id="wxServers"></span>   
        </div>
        <div class="box">
            <div><label>接收消息微信号：</label><input type="text" id="toUser" value="oskv9t8NdPTT-G0Beo41fOBM1bB8"/></div>
            <div><label>消息类型：</label><input type="text" id="msgType" value="text"/></div>
            <div><label>消息内容：</label><input type="text" id="msgContent" /></div>
            <input id="sendMessage" type="button" value="发送消息"/>
            <span class="left10" id="sendMessageResp"></span>   
        </div>
    </body>
    ...
    <script type="application/javascript">
        ...
        $("#accessTokenBtn").on("click",function(){
            $.ajax({
        ...
        $("#addKeFu").on("click",function(){
            $.ajax({
                url:"/admin/addKefu",
                method:"post",
                data:{account:$("#kf_account").val(),
                      nickName:$("#nickname").val(),
                      password:$("#password").val()
                     },
                success:function(data){
                    console.log(data)
                    $("#kefuRet").text(JSON.stringify(data));
                }
            });
        });
        
        $("#wxServersBtn").on("click",function(){
           $.ajax({
               url:"/admin/getcallbackip",
               success:function(data){
                    $("#wxServers").text(data.ip_list)
               }
           });
        });
        $("#sendMessage").on("click",function(){
            $.ajax({
               url:"/admin/sendCustomMessage",
               data:{
                   toUser:$("#toUser").val(),
                   msgType:$("#msgType").val(),
               ...
               success:function(data){
                    if(data.errcode==0){
                        $("#sendMessageResp").text("发送消息成功")
                    }else{
                        $("#sendMessageResp").text("发送消息失败。\n错误代码："+data.errcode+"。\n错误内容："+data.errmsg)
                    }
               }
           });
        });
